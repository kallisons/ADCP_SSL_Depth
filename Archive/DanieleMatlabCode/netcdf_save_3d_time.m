 function save_woce_corrected_o2(data,lon,lat,depth,time,varargin); 
 % 
 % Exampe: 
 % Arguments:
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if strcmp(A.mode,'clobber')
       ...
       nc_varput(filename,coordinate(4).Name,time);
    ...
    % corrects nans for ferret-style
     ...
     variable3d.Dimension = {'time','depth','latitude','longitude'};
